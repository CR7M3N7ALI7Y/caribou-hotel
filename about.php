        ...
        <div class="container">
            <div class="content-block">
                ...
                <div class="text-content">
                    <h2>Про Гостиницу</h2>
                    <p>Спа-отель «Карибу» расположен в тихом районе города Белоярский. Администрация позаботилась о том, чтобы уют, гармонично сочетался с их функциональностью и общими дополнительными преимуществами объекта.</p>
                    <p>Внутренняя отделка имеет серьезный и деловой стиль. Каждый номер имеет достаточную для пребывания площадь и рациональную меблировку. В ванных комнатах можно найти полностью исправную сантехнику, фен и набор белоснежных полотенец для каждого гостя.</p>
                    <p>Постояльцы и все желающие могут зайти на огонек в ресторан. Днем здесь предоставляется возможность выбора комплексного обеда из трех блюд, а вечером заведение превращается в бар с танцполом и шоу-программой.</p>
                    <p>Для переговоров с партнерами или проведения важного массового мероприятия на территории есть конференц-зал, в котором хороший звук, проведен Интернет и эргономичная мебель.</p>
